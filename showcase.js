  ...
  const scenes = [
    {
      ...
      panel: {
        ...
        metrics: [
          ['Founder Response', '24-72h', '68%'],
          ['Role Definitions', 'Required', '74%'],
          ['Project Scope', 'Reviewed', '72%'],
        ],
      },
    },
    {
      ...
      panel: {
        ...
        metrics: [
          ['Match Window', '1-3 days', '70%'],
          ['Role Fit', 'Skill-based', '76%'],
          ['Onboarding Start', 'Week 1', '66%'],
        ],
      },
    },
    {
      ...
      panel: {
        ...
        metrics: [
          ['Sprint Cadence', 'Weekly', '84%'],
          ['Check-ins', 'Midweek + Friday', '78%'],
          ['Delivery Focus', 'Shipped work', '73%'],
        ],
      },
    },
    {
      ...
      panel: {
        ...
        metrics: [
          ['Team Setup', 'Structured', '74%'],
          ['Priority Alignment', 'Founder-led', '82%'],
          ['Blocker Escalation', 'Weekly', '67%'],
        ],
      },
    },
    {
      ...
      panel: {
        ...
        metrics: [
          ['Contribution Logs', 'Maintained', '80%'],
          ['Equity Review', 'Checkpoint based', '76%'],
          ['Ownership Clarity', 'Transparent', '72%'],
        ],
      },
    },
  ];
